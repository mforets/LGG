...
def H_distance_vertices_brute_force(X, Y, norm=_sage_const_2 ):
    ...
    * "dH" : Hausdorff distance between P and Q.
    ...
    dXY = _sage_const_0 ; dYX = _sage_const_0 

    # find dXY
    aux_ext = (vector(base_ring, vertices_X[_sage_const_0 ]) - vector(base_ring, vertices_Y[_sage_const_0 ])).norm(norm);
    for vx in vertices_X:
        aux_int = (vector(base_ring, vx) - vector(base_ring, vertices_Y[_sage_const_0 ])).norm(norm)
    ...
    aux_ext = (vector(base_ring, vertices_X[_sage_const_0 ]) - vector(base_ring, vertices_Y[_sage_const_0 ])).norm(norm);
    for vy in vertices_Y:
        aux_int = (vector(base_ring, vertices_X[_sage_const_0 ]) - vector(base_ring, vy)).norm(norm)
        for vx in vertices_X:
            d = (vector(base_ring, vx) - vector(base_ring, vy)).norm(norm)
            if d < aux_int:
                aux_int = d
