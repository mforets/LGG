...
def _Omega_i_supports_hom(d, X0):
    ...
    for i in (ellipsis_range(_sage_const_0 ,Ellipsis,N-_sage_const_2 )):
        ...
        rho_X0_rip1 = supp_fun_polyhedron(X0, r[i+_sage_const_1 ], solver=solver, verbose=verbose)
        rho_expX0_rip1 = supp_fun_polyhedron(expX0, r[i+_sage_const_1 ], solver=solver, verbose=verbose)
        rho_alpha_tau_B_rip1 = supp_fun_polyhedron(alpha_tau_B, r[i+_sage_const_1 ], solver=solver, verbose=verbose)
        rhoi.append(s[i+_sage_const_1 ] + max(rho_X0_rip1, rho_expX0_rip1 + rho_alpha_tau_B_rip1))
